...
for ($i=1; $i < 4; $i++) { 
    ...
    echo '<img onmouseover="preview.src=img'.$i.'.src" name="img'.$i.'" src="image/mahmoud/'.$i.'.jpg">';
}
}
?>
...
<body>
    ...
    <section style="margin-top:20px;">
        ...
        <li>
        <a href="tel:01065058890" style="color:#000;">
        ...
        <img class="imgaa" src="image/mohamed.png"  alt=""/>
    </li>
            </ul>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <img class="imga" src="image/mohamed.png"  alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <h2 style="color:#000;">Gallery</h2>
                    ...
                    <div class="preview" align="center">
                        <img name="preview" src="image/mahmoud/1.jpg">
                    </div>
            </div>
