...
echo ' <div class="col-lg-3 col-md-3 col-sm-6 wow slideInRight "data-wow-duration="2s"   style="margin-bottom:15px;height:300px;width:380px;"><img src="image/pcb/'.$i. '.jpg" style="width:100%;height:100%;min-width: 100%;"></div>';
}
}
?>
