...
function input_sectionTwo(){
    ...
    <p class="lead" style="color:#fff;">We  Will Help You To achive Your Project Fast and Hight Quality 
    </p>
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="price-box wow slideInLeft "data-wow-duration="3s">
        
                <img src="image/download.jpg" style="width:100%;height:30%; " alt="">
                <h3 style="font-size:25px; font-weight:bold; ">Elctronics</h3>
                <h4 style="line-height:30px; margin:7px;color:#fff; font-style:italic;">Make your project as you need the project of all components and pcb design and complete them and give for you the final project good design and awsom helps</h4>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="price-box wow slideInRight data-wow-duration="3s"">
                <img src="image/pcb.jpg" style="width:100%;height:30%; " alt="">
                
                <h3 style="font-size:25px; font-weight:bold; ">PCB making</h3>
                <h4 style="line-height:25px;margin:7px; color:#fff; font-style:italic;">We are use the good matariles of our pcb single layer or double layer we use printing for pcb not CNC ,ithout green mask or via and the delivary for the near metro station   
            </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="price-box wow bounceInUp"data-wow-duration="3s">
                <img src="image/web.jpg" style="width:100%;height:30%; " alt="">
                
                
                <h3 style="font-size:25px; font-weight:bold; ">Web Developer</h3>
                <h4 style="line-height:25px; margin:7px;color:#fff; font-style:italic;">We will help use for making your Web site (front-end web page or back-end web page) that only page , with Database or edit of last projec  and we use the latest vegion of codeing that"s make any developer to edit of the project simply and give you The grace period after the project finshed to edit for it 
...
function input(){
    ...
    <span  ">Eng/Ahmed Alaa Soltan</span>
            <h2 >محامي بالاستئناف العالي</h2>
                    <p class="lead"  >القضايا المدنيه والجنائيه وتاسيس الشركات وصياغه العقود</p>
            
        </div>
        
        <div class="item">
        <span  >Eng/Mohamed Alaa Soltan</span>
            <h2>محامي بالاستئناف العالي</h2>
                    <p class="lead"  >القضايا المدنية والتجاريه وبراءه الاخترع </p>
            </div>
        
        <div class="item">
        
            <span >Des/Mahmoud Alaa Soltan</span>
            <h2>محامي بالاستئناف العالي</h2>
                    <p class="lead"  >قضايا الاحوال الشخصيه والتعامل مع هيئه الاستثمار وبرائه الاختراع</p>
            
        </div>
        
        <div class="item">
        
            <span >استاذ /	محمد عبد الناصر</span>
            <h2>محامي بالاستئناف العالي</h2>
                    <p class="lead"  >القضايا المدنيه والجنائيه وتاسيس الشركات وصياغه العقود</p>
                </div>
    ...
    <ol class="carousel-indicators ">
        ...
        <li data-target="#carosal_testimonial" data-slide-to="2"><img src="image/yolo-icons-160x160-nursemale2.png"/></li>
        <li data-target="#carosal_testimonial" data-slide-to="3"><img src="image/yolo-icons-160x160-nursemale2.png"/></li>
...
<div class="container">
    <div class="row port" >
        ...
        color: #fff;
        margin-top: 0px;
        text-shadow: -5px 2px #000;">Eng/Ahmed Alaa Soltan</h2>
        <h3 class="h33">A Student in New Cairo Academy of Computer Science and profissional fullstack web development work with language : </h3>
        <ul class="liport">
            <li>HTML &HTML5</li>
            <li>CSS &CSS3</li>
            <li>Bootstrap</li>
        ...
        <li>
        <svg style=" cursor: pointer;" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
    ...
    <li>
        <svg style=" cursor: pointer;" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
        <path d="M15.545 6.558a9.42 9.42 0 0 1 .139 1.626c0 2.434-.87 4.492-2.384 5.885h.002C11.978 15.292 10.158 16 8 16A8 8 0 1 1 8 0a7.689 7.689 0 0 1 5.352 2.082l-2.284 2.284A4.347 4.347 0 0 0 8 3.166c-2.087 0-3.86 1.408-4.492 3.304a4.792 4.792 0 0 0 0 3.063h.003c.635 1.893 2.405 3.301 4.492 3.301 1.078 0 2.004-.276 2.722-.764h-.003a3.702 3.702 0 0 0 1.599-2.431H8v-3.08h7.545z"/>
        </svg>
    </li>
    <li >
    <svg style=" cursor: pointer;" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
...
function portfolioMohamed(){
    ...
    <div class="container">
        ...
        <svg style=" cursor: pointer;" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <img class"imga" src="image/mohamed.jpg"  alt="">
        </div>
    </div>
</div>
</section>
